...
describe RakeVersion::Copier do
  ...
  it "should require no arguments" do
    expect(lambda{ RakeVersion::Copier.new }).not_to raise_error
  end
  ...
  it "should accept glob strings and regexps as arguments" do
    [
      ...
      expect(lambda{ RakeVersion::Copier.new *args }).not_to raise_error
    end
  end
  ...
  it "should only accept glob strings and regexps as arguments" do
    ...
    [ nil, true, false, [], Object.new, :symbol ].each do |invalid|
      expect(lambda{ RakeVersion::Copier.new invalid }).to raise_error(RakeVersion::BadFilePattern)
    end
  end

  it "should take options" do
    expect(lambda{ RakeVersion::Copier.new :option1 => true, :option2 => false }).not_to raise_error
  end
